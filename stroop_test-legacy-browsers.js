...
function daojishi1RoutineBegin(snapshot) {
  return async function () {
    ...
    daojishi1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function daojishi2RoutineBegin(snapshot) {
  return async function () {
    ...
    daojishi2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function daojishi3RoutineBegin(snapshot) {
  return async function () {
    ...
    daojishi3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
